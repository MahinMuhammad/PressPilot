//
//  TapTargetResetLayer.swift
//  PressPilot
//
//  Created by Md. Mahinur Rahman on 9/7/23.
//

//strange offset on tap when reopening app with a `sheet` open
//strange offset on tap when `sheet` orientation changed
...
public struct TapTargetResetLayer: View {
    ...
    public var body: some View {
        textField
            ...
            .onChange(of: verticalSizeClass!, perform: orientationChanged)
    ...
    func orientationChanged(to newOrientation: UserInterfaceSizeClass){
        focusWhenVisible = true
        wasInBackground = false /// reset for next use
    }
